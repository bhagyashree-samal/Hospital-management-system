...
export const getServiceAppointments = async (req, res) => {
  try {
    ...
    const appointments = await serviceAppointment
      .find(filter)
...
export default {createServiceAppointment,confirmServicePayment,cancelServiceAppointment,getServiceAppointmentById,getServiceAppointments,getserviceAppointmentByPatient,getserviceAppointmentStats,updateServiceAppointment}