...
const AddService = ({ serviceId }) => {
  ...
  const ampm = ["AM", "PM"];
  //inital value as strings matching options
  ...
  //compute the days for selecting month/year (respecting the month length)
  ...
  //user cant select previous date or year
  useEffect(() => {
        ...
        {toast && (
          <div
            className={`${addServiceStyles.toast.toastBase} 
                ${toast.type === "error" ? addServiceStyles.toast.toastError : toast.type === "info" ? addServiceStyles.toast.toastInfo : addServiceStyles.toast.toastSuccess} animate-slideIn`}
          >
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4">
          ...
          <div className={addServiceStyles.headerActions}>
            ...
            >
              {submitting ? (
                <>
                  <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spain">
                    Saving...
                  </div>
                </>
              ) : (
