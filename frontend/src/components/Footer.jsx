...
import { footerStyles, listPageStyles } from "../assets/dummyStyles";
    ...
    <footer className={footerStyles.footerContainer}>
      ...
      <div className={footerStyles.mainContent}>
        <div className={footerStyles.gridContainer}>
          <div className={footerStyles.companySection}>
            <div className={footerStyles.logoContainer}>
              ...
              <div>
                <h2 className={footerStyles.companyName}>AROGYAPLUS</h2>
            ...
            <div className={footerStyles.contactContainer}>
              <div className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>+91 8299931245</span>
              </div>
        ...
        <div className={footerStyles.copyright}>
            <span> &copy; {currentYear} AROGYAPLUS Healthcare. </span>            
        </div>
        <div className={footerStyles.designerText}>
            <span>Designed by</span>
            <a href="https://www.bhagyashreesamal.com" target="_blank" className={footerStyles.designerLink}>Group-13</a>
        </div>
        </div>
      </div>
